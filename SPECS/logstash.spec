...
Patch0:         001-logstash-output-s3__temporary_directory.patch
Patch1:         002-logstash-output-s3__temporary_directory_owner.patch
...
Patch5:         006-logstash-input-gelf__timestamp_fix.patch
BuildArch:      noarch
...
cp -ar Gemfile %{buildroot}%{LS_home}
cp -ar Gemfile.jruby-1.9.lock %{buildroot}%{LS_home}
...
%changelog
* Wed Dec 23 2015 vitvegl@quintagroup.org 2.0.0-3
- logstash-input-gelf (timestamp patch)
- https://github.com/vitvegl/logstash-input-gelf/commit/ee5084af88de358051f8b5222ee23da49e64e01a

* Mon Nov 23 2015 vitvegl@quintagroup.org 2.0.0-2
- input-s3 and output-s3 patches

* Mon Nov 16 2015 vitvegl@quintagroup.org 2.0.0-1
- Update logstash to version 2.0.0
